...
function ViewOnlyHomeContent() {
  ...
  return (
    <div className="min-h-screen bg-[#fafbfa] text-[#1c3a1e] font-sans antialiased flex flex-col justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#d4af37] font-bold">
                {menuMode === 'camping' ? '🏕️ Camping & Picnic Menu' : '🍽️ Restaurant Menu'}
              </p>
            </div>
          </div>
                    ...
                    {catItems.map((item) => {
                      ...
                      return (
                        <div
                          ...
                          className={`bg-white rounded-2xl overflow-hidden flex flex-row items-center p-3 gap-3.5 transition-all group border border-[#1c3a1e]/10 shadow-sm ${
                            isOutOfStock
                          ...
                          <div className="relative h-24 w-24 sm:h-28 sm:w-28 bg-[#f4f7f4] rounded-xl overflow-hidden flex-shrink-0 flex items-center justify-center border border-[#1c3a1e]/10">
                            <img
                              ...
                              className={`w-full h-full ${
                                item.image_url ? 'object-cover' : 'object-contain p-4 opacity-50 filter invert'
      ...
      <footer className="py-4 border-t border-[#1c3a1e]/10 text-center text-xs text-gray-500 bg-white">
        <div className="max-w-3xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <span>Skylight Village Digital Menu &bull; All Rights Reserved</span>
          <Link
            href="/hub"
            className="inline-flex items-center gap-1 text-[11px] font-bold text-gray-400 hover:text-[#1c3a1e] transition-colors"
          >
