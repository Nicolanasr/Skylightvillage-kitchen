                            ...
                            <div className="flex-1">
                              <div className="flex justify-between items-start">
                                ...
                                <button
                                  ...
                                  className={`text-[10px] font-black px-2.5 py-1 rounded-full flex items-center gap-1.5 border shadow-xs transition-all cursor-pointer ${
                                    item.available
                                ...
                                >
                                  ...
                                  <span>{item.available ? 'AVAILABLE (CLICK TO TOGGLE)' : 'SOLD OUT (CLICK TO UNLOCK)'}</span>
                                </button>
                              </div>
